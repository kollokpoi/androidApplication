    ...
    public partial class secondMigration : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ApartamentStatus", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApartamentNumber = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Apartament_ApartamentStatus_StatusId",
                        column: x => x.StatusId,
                        principalTable: "ApartamentStatus",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Apartament_Objects_ObjectId",
                        column: x => x.ObjectId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ObjectUser", x => new { x.ObjectsId, x.UsersId });
                    table.ForeignKey(
                        name: "FK_ObjectUser_Objects_ObjectsId",
                        column: x => x.ObjectsId,
                        principalTable: "Objects",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ObjectUser_Users_UsersId",
                        column: x => x.UsersId,
                        principalTable: "Users",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Apartament_ObjectId",
                table: "Apartament",
                column: "ObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Apartament_StatusId",
                table: "Apartament",
                column: "StatusId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ObjectImage_ObjectId",
                table: "ObjectImage",
                column: "ObjectId");

            migrationBuilder.CreateIndex(
                name: "IX_Objects_ChatId",
                table: "Objects",
                column: "ChatId");

            migrationBuilder.CreateIndex(
                name: "IX_ObjectUser_UsersId",
                table: "ObjectUser",
                column: "UsersId");
